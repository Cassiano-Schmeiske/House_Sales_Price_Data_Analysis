...
# get data
path = 'C:\\Users\\Uuser\\repos_git\\House_Sales_Price_Data_Analysis\\data\kc_house_data.csv'
data = get_data( path )
...
std = pd.DataFrame( num_attributes.apply( np.std ) ) #desvio padrão
...
#=============================================================
# Distribuição dos imióveis por categorias comerciais
#=============================================================
...
#=============================================================
# Distribuição dos imióveis por categorias fisicas
#=============================================================
